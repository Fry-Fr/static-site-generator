...
class TestTextNode(unittest.TestCase):
    ...
    def test_url_raises_exception(self):
        ...
        self.assertEqual(str(cm_1.exception), "url must be provided for IMAGE text_type")
        ...
        self.assertEqual(str(cm_2.exception), "url must be provided for IMAGE text_type")
